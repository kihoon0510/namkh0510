...
public class MainClass {
	public static void main(String[] args) {
		...
		System.out.println(new
		  ...
		  InstanceCount instanceCount = new
		  ...
		  // no04 
		  MyStack stack = new MyStack(100); stack.push("hi");
		  ...
		  */
		  ...
		  StringReaderExtends extends1 = new StringReaderExtends(str);
		  extends1.readLine();
